...
Feedstock license: [BSD-3-Clause](https://github.com/hep-forge/yoda-feedstock/blob/main/LICENSE.txt)
...
Note that all branches in the hep-forge/yoda-feedstock are
